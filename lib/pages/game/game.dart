...
import 'package:grip/extensions/app_button.dart';
...
import 'package:grip/extensions/system_utils.dart';
import 'package:grip/extensions/text_styles.dart';
import 'dart:async';
import 'dart:math';
import 'package:grip/logic/game_data.dart';
...
class _GameState extends State<Game> with TickerProviderStateMixin {
  ...
  void _startAnimation(int index) {
    RenderBox? box = _boxKeys[index].currentContext?.findRenderObject() as RenderBox?;
    RenderBox? actionBar = _actionBarKey.currentContext?.findRenderObject() as RenderBox?;
    if (box != null) {
      setState(() {
        _isAnimating = true;
        _startPosition = box.localToGlobal(Offset.zero);
        _endPosition = actionBar!.localToGlobal(Offset(actionBar.size.width - 40, -8));
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AnimatedBackground(
        behaviour: RandomParticleBehaviour(options: particleOptions, paint: particlePaint),
        vsync: this,
        child: SafeArea(
          child: Stack(
            children: [
                            ...
                            child: InkWell(
                                ...
                                child: Ink(
                                  ...
                                  decoration: ShapeDecoration(
                                    color: gameData.targetIndex == index ? targetColor : dummyColor,
            ...
            child: SimpleDialog(
              ...
              children: [
                ...
                SimpleDialogOption(
                  ...
                  child: Center(child: Text('Main menu', style: primaryTextStyle(size: 22))),
                ),
              ],
            ),
          );
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      ...
                      style: primaryTextStyle(size: 16, weight: FontWeight.bold, color: appStore.isDarkMode ? Colors.white : scaffoldColorDark),
                    ),
                    10.height,
                    AppButton(
                      text: 'Exit',
