...
abstract class AppStoreBase with Store {
  ...
  @observable
  String selectedLanguageCode = defaultLanguageCode;
  ...
  Future<void> setLanguage(String aCode, {BuildContext? context}) async {
   ...
   /* setDefaultLocate();
    ...
    if (context != null) languages = BaseLanguage.of(context)?? await AppLocalizations().load(Locale(selectedLanguageCode));
    languages = await AppLocalizations().load(Locale(selectedLanguageCode));*/
