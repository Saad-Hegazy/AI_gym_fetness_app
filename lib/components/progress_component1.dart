...
class ProgressComponent1 extends StatefulWidget {
  ...
  ProgressComponent1({this.mGraphModel, this.mType, this.mUnit, this.onCall, this.data});
...
class ProgressComponent1State extends State<ProgressComponent1> {
  ...
  Future<void> save({String? id}) async {
    if (formKey.currentState!.validate()) {
      Map req;
      if (mIsUpdate) {
        req = {"id": id, "value": widget.data, "type": widget.mType, "unit": widget.mUnit, "date": countDownCont.text};
      } else {
        req = {"value": widget.data, "type": widget.mType, "unit": widget.mUnit, "date": countDownCont.text};
      }
                  ...
                  mIsUpdate == true
                      ? Row(
                          children: [
                            ...
                            AppButton(
                              ...
                              onTap: () {
                                widget.data = calculateIdealBodyWeight(height, age, mGender);
                      ...
                      : AppButton(
                          ...
                          onTap: () {
                            widget.data = calculateIdealBodyWeight(height, age, mGender);
                            save();
                            print("-------->${calculateIdealBodyWeight(height, age, mGender)}");
