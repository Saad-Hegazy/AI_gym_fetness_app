...
import 'package:grip/widget/custome_height_picker.dart';
import 'package:grip/widget/weight_widget.dart';
...
//Convert lbs to kg
  ...
  void _openWightPickerBottomSheet(BuildContext context) async {
    final res = await showModalBottomSheet<Tuple2<WeightType, double>>(
      ...
      elevation: 0,
      enableDrag: false,
      transitionAnimationController: AnimationController(vsync: this, duration: const Duration(milliseconds: 800)),
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  ...
                  max: weightType.name == languages.lblKg ? 200 : 400,
                  initialValue: weight,
                  type: weightType,
                  onChanged: (value) {
