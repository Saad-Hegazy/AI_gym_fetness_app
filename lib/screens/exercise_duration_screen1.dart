...
class ExerciseDurationScreen1State extends State<ExerciseDurationScreen1> {
  ...
  Future<void> initializePlayer() async {
    _videoPlayerController1 = VideoPlayerController.networkUrl(Uri.parse(widget.mExerciseModel!.data!.videoUrl.validate()));
  ...
  Widget build(BuildContext context) {
   // bool isLandscape = MediaQuery.of(context).orientation == Orientation.landscape;
    return Scaffold(
      //appBar: isLandscape ? null : appBarWidget(widget.mExerciseModel!.data!.title.validate(), context: context),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            widget.mExerciseModel!.data!.videoUrl.validate().contains("https://www.youtu")
                ? AspectRatio(
                aspectRatio: 12 / 7,
                child: YoutubePlayerBuilder(
                  ...
                  player: YoutubePlayer(
                    ...
                    thumbnail: cachedImage(widget.mExerciseModel!.data!.exerciseImage.validate(), fit: BoxFit.fill, height: context.height()).cornerRadiusWithClipRRect(0),
              ...
              child: _chewieController != null && _chewieController!.videoPlayerController.value.isInitialized
                  ...
                  : cachedImage(widget.mExerciseModel!.data!.exerciseImage.validate(), fit: BoxFit.fill, height: context.height()).cornerRadiusWithClipRRect(0),
            ).center(),
            30.height,
            if (widget.mExerciseModel!.data!.sets != null)
              Row(
