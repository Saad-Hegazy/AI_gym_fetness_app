              ...
              Row(
                children: [
                  ...
                  AppTextField(
                    ...
                    decoration: defaultInputDecoration(context, label: languages.lblSearchExercise),
                    onChanged: (v) {
                      mSearchValue = v;
                      mIsSearch = true;
                      mExerciseList.clear();
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: Text(list[index].title.toString(),
                        style: secondaryTextStyle(color: list[index].select! ? Colors.white : textSecondaryColorGlobal), maxLines: 1, overflow: TextOverflow.ellipsis),
                  ).onTap(() async {
                        ...
                        builder: (BuildContext context) {
                          ...
                          return SearchCategoryBottomSheet(
                            ...
                            onCall: (List<int> mList) {
                              SelectedId = mList.toString().removeAllWhiteSpace().replaceAll("[", "").replaceAll("]", "").trim();
              ...
              mSearchValue.isEmptyOrNull
                  ? mExerciseList.isNotEmpty
                      ...
                      : SizedBox(
                          ...
                          child: NoDataScreen(mTitle: languages.lblExerciseNoFound).center().visible(!appStore.isLoading),
                        )
                  : Stack(
                      children: [
