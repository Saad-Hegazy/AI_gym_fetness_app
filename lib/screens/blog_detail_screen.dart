...
import 'package:grip/components/HtmlWidget.dart';
...
class _BlogDetailScreenState extends State<BlogDetailScreen> {
  ...
  init() async {
    if (userStore.adsBannerDetailShowAdsOnBlogDetail == 1) loadInterstitialAds();
  ...
  @override
  void dispose() {
    if (userStore.adsBannerDetailShowAdsOnBlogDetail == 1) showInterstitialAds();
    super.dispose();
  }
                      ...
                      child: Column(
                        ...
                        children: [
                           ...
                           Wrap(
                            ...
                            children: widget.mBlogModel?.categoryName
                                    ?.map((category) => Padding(
                                          padding: const EdgeInsets.only(left: 13,top: 10,bottom: 5,right: 5),
                                          child: Row(
                          ...
                          /* ? Wrap(
                              ...
                              : SizedBox().paddingOnly(top: 16),*/
                          if (!appStore.isLoading) HtmlWidget(postContent: mBlog?.description.validate()).paddingSymmetric(horizontal: 8),
                          16.height,
                        ],
                      ),
                    ),
