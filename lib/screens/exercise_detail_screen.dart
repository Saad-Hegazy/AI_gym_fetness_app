...
import 'package:grip/screens/chewie_screen.dart';
import 'package:grip/screens/exercise_duration_screencast.dart';
      ...
      appBar: PreferredSize(
        ...
        child: Visibility(
          ...
          child: appBarWidget(widget.mExerciseName.validate(), context: context, actions: [
            Image.asset(ic_menu, height: 24, width: 24, color: primaryColor).paddingRight(16).onTap(() {
              TipsScreen(
        ...
        child: AppButton(
          ...
          onTap: () {
            if (mExerciseModel?.data?.type == "duration") {
              ExerciseDurationScreen(mExerciseModel, widget.workOutId).launch(context);
            } else {
              ExerciseDurationScreencast(mExerciseModel: mExerciseModel, workOutId: widget.workOutId).launch(context);
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Stack(
                    children: [
                      mExerciseModel!.data!.videoUrl.validate().contains("https://youtu") || mExerciseModel!.data!.videoUrl.validate().contains("https://www.youtu")
                          ? AspectRatio(
                              aspectRatio: mode == "portrait" ? 12 / 7 : 15 / 7,
                              child: YoutubePlayerScreen(url: mExerciseModel!.data!.videoUrl.validate(), img: mExerciseModel!.data!.exerciseImage.validate(), hideControl: true))
                          : ChewieScreen(url: mExerciseModel!.data!.videoUrl.validate(), image: mExerciseModel!.data!.exerciseImage.validate(), autoPlay: false).center(),
                      Positioned(
                        left: 16,
                        top: 16,
