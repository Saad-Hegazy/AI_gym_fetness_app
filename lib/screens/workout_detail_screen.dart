                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (!appStore.isLoading)
                                Column(
                                  children: [
                                    HtmlWidget(postContent: mWorkoutDetailModel?.description.validate()).paddingSymmetric(horizontal: 8).visible(!(mWorkoutDetailModel?.description.isEmptyOrNull??false)),
                                    20.height,
                                    TabBar(
                                        ...
                                        mDayExerciseList.isNotEmpty
                                            ? AnimatedListView(
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return ExerciseDayComponent(mDayExerciseModel: mDayExerciseList[index], mSets: mSets,workOutId:widget.id.toString());
                                                },
                                              )
                                            : Text(mWorkoutDayList.isEmpty || currentTabIndex < 0 || currentTabIndex >= mWorkoutDayList.length?languages.lblNoFoundData:mWorkoutDayList[currentTabIndex].isRest == 1 ? languages.lblBreak : languages.lblNoFoundData, style: secondaryTextStyle())
                                                .center()
                                                .paddingOnly(top: 50)
