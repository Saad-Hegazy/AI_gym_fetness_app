...
class _DietDetailScreenState extends State<DietDetailScreen> {
  ...
  @override
  void dispose() {
    if (userStore.adsBannerDetailShowAdsOnDietDetail == 1) showInterstitialAds();
    super.dispose();
  }
  ...
  Widget instruction() {
    return HtmlWidget(postContent: widget.dietModel!.description.toString()).paddingSymmetric(horizontal: 8);
  }
