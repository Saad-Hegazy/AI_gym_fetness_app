...
import 'package:grip/components/scheduled_component.dart';
...
import 'package:grip/extensions/widgets.dart';
import 'package:grip/main.dart';
import 'package:grip/models/ScheduledResponse.dart';
              ...
              Expanded(
                child: AnimatedListView(
                  ...
                  itemBuilder: (context, index) {
                    return ScheduledComponent(scheduledWorkoutList: scheduledWorkoutList[index], myCallback: (String price,String id) async {
                      String? refresh="";//await PaymentScheduledScreen(price: price,sceduledId:id).launch(context);
                      if(refresh=='refresh'){
                        CallScheduleApi();
                      }
                    },);
