...
import 'package:grip/utils/app_common.dart';
          ...
          return GestureDetector(
              ...
              child: Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: selectedImageIndex == index ? primaryColor : Colors.transparent, // Highlight if selected
                      width: 2.0,
                    ),
                  ),
                  child: cachedImage(questionImageList[index], height: 100, fit: BoxFit.cover, width: 100).cornerRadiusWithClipRRect(16)));
        }),
      ),
    );
  }
