...
import 'package:grip/extensions/time_formatter.dart';
...
DateFormat getGlobalDateFormat() {
  return DateFormat('dd/MM/yyyy HH:mm');
}

//global format used for reminders data time DATA TYPE DateTime
DateTime getDateTime(String data) {
  return DateFormat('yyyy-MM-dd HH:mm').parse(data);
}

//global format used for reminders data time DATA TYPE string
String getDateTimeString(DateTime data) {
